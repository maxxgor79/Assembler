package ru.zxspectrum.io.audio.generator;
...
import ru.zxspectrum.io.tzx.DataBlock;
...
public class SignalGenerator extends Generator implements Signal {
    ...
    protected void generateWavFromTzx(@NonNull final TzxData tzxData) throws IOException {
        ...
        int i = 0;
        for (final ru.zxspectrum.io.tzx.Block block : tzxData.getBlocks(DataBlock.DEFAULT_ID)) {
