...
public enum Operator {
    ...
    , READ(0xe3), DATA(0xd4), RESTORE(0xe5), NEW(0xe6), BORDER(0xe7), CONTINUE(0xe8)
    ...
    public static Operator get(int code) {
        initTable();
        return operatorMap.get(Integer.valueOf(code));
    }
    ...
    private static void initTable() {
        if (operatorMap == null) {
            ...
            for (Operator op : values()) {
                operatorMap.put(Integer.valueOf(op.code), op);
            }
        }
    }
