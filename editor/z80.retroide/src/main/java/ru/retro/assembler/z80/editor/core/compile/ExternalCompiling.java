...
public class ExternalCompiling implements Compiling {
    ...
    public void compile(@NonNull final Source src, String... args) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(mainWindow, String.format(Z80Messages.getInstance().get(Z80Messages.FILE_NOT_FOUND)
            ...
            JOptionPane.showMessageDialog(mainWindow,
                    String.format(Z80Messages.getInstance().get(Z80Messages.IO_ERROR), src.getFile()
                            .getAbsolutePath()), Z80Messages.getInstance().get(Z80Messages.ERROR), JOptionPane.ERROR_MESSAGE
