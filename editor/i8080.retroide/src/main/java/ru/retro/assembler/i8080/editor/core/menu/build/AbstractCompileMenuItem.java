...
import ru.retro.assembler.i8080.editor.core.compile.EmbeddedCompiling;
import ru.retro.assembler.i8080.editor.core.compile.ExternalCompiling;
...
abstract class AbstractCompileMenuItem extends AbstractMenuItem {
  ...
  protected void compile(@NonNull final Source src, String... args) {
    ...
    if (!controller.getSettings().isCompiledEmbedded()) {
      final ExternalCompiling compiling = new ExternalCompiling(controller);
      compiling.compile(src, args);
    } else {
      final EmbeddedCompiling compiling = new EmbeddedCompiling(controller);
      compiling.compile(src, args);
    }
  }
  ...
  public boolean isEnabled() {
    ...
    if (selectedSource != null) {
      ...
      return text != null && !text.trim().isEmpty()
          && controller.getMainWindow().getSourceTabbedPane()
          .getTabCount() != 0;
    }
