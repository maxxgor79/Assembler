...
public class RecorderMenuItems extends AbstractMenuItem {
    ...
    public RecorderMenuItems(@NonNull Controller controller) {
        super(controller, I8080Messages.getInstance().get(I8080Messages.RECORDER), (char) 0, KeyStroke
                .getKeyStroke(KeyEvent.VK_F11, InputEvent.ALT_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK)
                , "/icon16x16/cassette.png");
