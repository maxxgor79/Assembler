...
public class ExternalCompiling implements Compiling {
    ...
    public void compile(@NonNull final Source src, String... args) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(mainWindow, String.format(I8080Messages.getInstance().get(I8080Messages.FILE_NOT_FOUND)
                            , pathToAsm.getAbsolutePath()), I8080Messages.getInstance().get(I8080Messages.ERROR)
                    , JOptionPane.ERROR_MESSAGE, ResourceUtils.getErrorIcon());
        } catch (IOException e) {
            log.error(e.getMessage(), e);
            JOptionPane.showMessageDialog(mainWindow,
                    String.format(I8080Messages.getInstance().get(I8080Messages.IO_ERROR), src.getFile()
                            .getAbsolutePath()), I8080Messages.getInstance().get(I8080Messages.ERROR), JOptionPane.ERROR_MESSAGE
