...
public class EditMenuItems {
    ...
    private void initComponents() {
        miUndo = new JMenuItem(Messages.getInstance().get(Messages.UNDO));
        ...
        miCut = new JMenuItem(Messages.getInstance().get(Messages.CUT));
        miCut.setMnemonic('T');
        ...
        miCopy = new JMenuItem(Messages.getInstance().get(Messages.COPY));
        ...
        miPaste = new JMenuItem(Messages.getInstance().get(Messages.PASTE));
        ...
        miFindNext = new JMenuItem(Messages.getInstance().get(Messages.FIND_NEXT));
        miFindNext.setMnemonic('E');
        miFindNext.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, InputEvent.CTRL_DOWN_MASK));

        miReplace = new JMenuItem(Messages.getInstance().get(Messages.REPLACE));
