...
public class FileMenuItems {
    ...
    private void initComponents() {
        miNew = new JMenuItem(Messages.getInstance().get(Messages.NEW));
        miNew.setMnemonic('N');
        ...
        miOpen = new JMenuItem(Messages.getInstance().get(Messages.OPEN));
        ...
        miSaveAll = new JMenuItem(Messages.getInstance().get(Messages.SAVE_ALL));
        miReloadAllFromDisk = new JMenuItem(Messages.getInstance().get(Messages.RELOAD_ALL_FILES));
        ...
        miCloseAll = new JMenuItem(Messages.getInstance().get(Messages.CLOSE_ALL));
        miPrint = new JMenuItem(Messages.getInstance().get(Messages.PRINT) + "...");
        ...
        miExit = new JMenuItem(Messages.getInstance().get(Messages.EXIT));
